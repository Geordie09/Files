...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        saveGame("//D://Games//savegames//gameProgress1.dat", gameProgress1);
        saveGame("//D://Games//savegames//gameProgress2.dat", gameProgress2);
        saveGame("//D://Games//savegames//gameProgress3.dat", gameProgress3);

        ArrayList<String> arrayList = new ArrayList<>();

        arrayList.add("//D://Games//savegames//gameProgress1.dat");
        arrayList.add("//D://Games//savegames//gameProgress2.dat");
        arrayList.add("//D://Games//savegames//gameProgress3.dat");

        zipFiles("//D://Games//savegames//zipGames.zip", arrayList);

        File gameProgress1Data = new File("//D://Games//savegames//gameProgress1.dat");
        File gameProgress2Data = new File("//D://Games//savegames//gameProgress2.dat");
        File gameProgress3Data = new File("//D://Games//savegames//gameProgress3.dat");
